...
namespace Capstone.Web.Models
{
    public class Survey
    {
        ...
        [Required(ErrorMessage = "Select The Park You Attended")]
        public string ParkCode { get; set; }
        [Required(ErrorMessage = "Enter Your E-Mail")]
        public string Email { get; set; }
        [Required(ErrorMessage = "Select Your State Of Residence")]
        public string State { get; set; }
        [Display(Name ="What is the frequency of your camping activity")]
        [Required(ErrorMessage = "Select Your Activity Level")]
